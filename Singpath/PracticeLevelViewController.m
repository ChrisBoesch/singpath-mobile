...
#import "deepend.h"
//This class is responsible for the display of levels in practice mode
...
-(void)goToHome{
    ...
    PracticePathViewController* mainScreen = (PracticePathViewController*)[storyboard instantiateViewControllerWithIdentifier:@"PracticePathViewController"];
